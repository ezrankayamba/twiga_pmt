...
class ProjectCreateForm(ModelForm):
    class Meta:
        ...
        fields = ['name', 'type', 'start_date', 'region', 'district', 'town', 'duration', 'authority', 'consultant', 'remarks']
        widgets = {
...
class ProjectUpdateForm(ModelForm):
    class Meta:
        model = models.Project
        fields = ['name', 'type', 'start_date', 'status', 'region', 'district', 'town', 'duration', 'authority', 'consultant', 'remarks']
        widgets = {
            'remarks': Textarea(attrs={'rows': 2}),
